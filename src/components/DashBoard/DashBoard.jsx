...
function DashBoard() {
    ...
    useEffect(() => {
        const handlerData = async () => {
            try {
                const response = await fetchData.getData('/user/authenticateCookiesToken');
                console.log(process.env.REACT_APP_APi_URL + '/user/authenticateCookiesToken')
                setData(response);
                isLoading(true);
            } catch (error) {
                if (error.response && (error.response.status === 400 || error.response.status === 403)) {
                    alert('Authentication not valid. Please log in again.');
                    navigate('/');
                }
            }
        };
    ...
    return (
        <div classNameName="h-screen overflow-hidden flex items-center justify-center">
            <div className="flex h-screen bg-gray-200">
                <div className={clsx('fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0', !sideBar ? 'max-md:hidden' : 'max-md:block')}>
                    <div className="flex items-center justify-center mt-8">
                        <div className="flex items-center">
                            ...
                            <Link to='/' className="mx-2 text-2xl font-semibold text-white">Dashboard</Link>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 overflow-hidden">
                    <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                        <div className="flex items-center">
                            <button className="text-gray-500 focus:outline-none lg:hidden" onClick={() => {
                                setsideBar(!sideBar);
                            }}>
                            ...
                            <div className="relative mx-4 lg:mx-0">
                                ...
                                <input className="w-32 pl-10 pr-4 rounded-md form-input sm:w-64 focus:border-indigo-600 h-12 border-2" type="text"
                                    placeholder="Search" />
                            </div>
                        </div>
                        ...
                        <div className="flex items-center">
                            <div className="relative">
                                <button className="flex mx-4 text-gray-600 focus:outline-none" onClick={() => {
                                    setState(!state)
                                }}>
                                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div
                                    className="fixed inset-0 z-10 w-full h-full hidden" ></div>

                                <div
                                    className={clsx("absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-xl w-80", state ? "block" : "hidden")}
                                >
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute right-0 z-10 w-48 mt-2 overflow-hidden hidden bg-white rounded-md shadow-xl">
                                    <a href="#"
                                                            ...
                                                            <tr>
                                                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 ">
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        <div className="ml-4">
                                                                            <div className="text-sm font-medium leading-5 text-gray-900">{user.User_Name}
                                                                            </div>
                                                                ...
                                                                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 ">
                                                                    <div className="ml-4">
                                                                        <div className="text-sm font-medium leading-5 text-gray-900">{user.status}
                                                                        </div>
                                                                        <div className="text-sm leading-5 text-gray-500">john@example.com</div>
                                                                    </div>
                                                                </td>
